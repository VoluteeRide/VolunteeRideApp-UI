...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
            ...
            self.internalBaseClassIdentifier = [self objectOrNilForKey:kRideSeekerId fromDictionary:dict];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:self.internalBaseClassIdentifier forKey:kRideSeekerId];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.internalBaseClassIdentifier = [aDecoder decodeObjectForKey:kRideSeekerId];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:_internalBaseClassIdentifier forKey:kRideSeekerId];
