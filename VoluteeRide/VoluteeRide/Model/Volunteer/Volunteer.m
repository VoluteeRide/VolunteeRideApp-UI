...
@synthesize volunteerIdentifier = _volunteerIdentifier;
...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
            ...
            self.volunteerIdentifier = [self objectOrNilForKey:kVolunteerId fromDictionary:dict];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:self.volunteerIdentifier forKey:kVolunteerId];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.volunteerIdentifier = [aDecoder decodeObjectForKey:kVolunteerId];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:_volunteerIdentifier forKey:kVolunteerId];
...
- (id)copyWithZone:(NSZone *)zone
{
    ...
    if (copy) {
        ...
        copy.volunteerIdentifier = [self.volunteerIdentifier copyWithZone:zone];
